...
%Grafové databáze poskytují pro analýzu dat dvě základní možnosti, spouštění algoritmů pomocí analytického enginu a vykonávání dotazů (podobné SQL dotazům) pomocí dotazovacího enginu.
