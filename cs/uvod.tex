...
Grafové databáze zažívají v dnešní době rozkvět, například kvůli nutnosti analyzovat data na sociálních sítích, jsou flexibilnější než relační databáze při rozšiřování datového modelu a jednoduše ztvárňují informace o vztazích mezi entitami.
...
\item \texttt{count(...)}, která počet prvků ve skupině.
