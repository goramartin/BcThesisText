...
První část je statická grafová databáze využívající \textbf{Labeled-property} model grafových dat. 
...
\item
Obecně \textit{Order by} řešení využívaly k třídění implementaci \textit{(a, 2a)}-stromu.
