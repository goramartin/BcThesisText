...
\end{itemize}
V jednovláknovém zpracování jsou řešení totožná, tj. třídí se pouze pomocí stromu a nedochází ke slévání.
...
V jednovláknovém zpracování jsou řešení totožná, tj. třídí se pouze pomocí jednoho stromu (je jen jedna přihrádka).
...
Druhý vypíše tabulku výsledků ve formátu Markdown\footnote{https://www.markdownguide.org/} tabulky.
...
Po načtení je uživatel vyzván aby zadal vstupní dotaz k vykonání:
\begin{code}
Enter Query:
\end{code}
Uživatel zadá dotaz jazykem PGQL z sekce \ref{req.pgql}.
Každý dotaz musí být ukončen znakem „;“.
Stisknutím tlačítka „Enter“ dojde k zahájení zpracování dotazu.
Po dokončení je uživatel vyzván, aby zadal další dotaz nebo ukončil aplikaci:
\begin{code}
...
„n“ ukončí aplikaci.
Stistknutím „Enter“ se vykoná daná akce.
