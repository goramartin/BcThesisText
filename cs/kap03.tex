...
\texttt{interface Creator<T>} s metodou \texttt{T Create()} je vzor pro tvorbu objektů \texttt{T}.
Tento vzor rozšíříme na třídu \texttt{CreatorFromFile<T>}, která symbolizuje tvorbu objektu \texttt{T} ze souboru.
Třída očekává při incializaci třídu čtoucí vstupní soubor po částech \texttt{IReader}.
A třídu vytvářející iterativně \texttt{T} na základě poskytnutých částí souboru \texttt{IProcessor}.
Protože text je čtený po částech, tak IProcessor implementuje návrhový vzor State.
