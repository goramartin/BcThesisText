...
Části dotazu budou reprezentovány třídami (obrázek \ref{figure.diaQueryObjects}), které si implementují interně svou logiku.
Třídy budou zřetězeny dle priority výše (obrázek xxx), tj. tvoří se exekuční plán z uživatelského dotazu.
Vykonání je zobrazeno na obrázku zzz.

\begin{figure}[!htp]
\includegraphics[width=\linewidth]{../img/diaQueryObjects.pdf}\centering
\caption{AAA}
