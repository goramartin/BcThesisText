...
\textit{Zbývá nám vyřešit fungování částí Group by a Order by. 
Je nutné si uvědomit, že dané části představují referenční řešení pro budoucí vylepšení, které zpracuje výsledky v průběhu prohledávání grafu.}
...
\subsection{Optimalizace vs paralelismus}
...
V prvním případě dochází k uchovávání výsledků lokálních pro vlákno.
