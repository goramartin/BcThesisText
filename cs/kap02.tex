...
\texttt{propName} je zde název vlastnosti.
...
\end{code}
Pro vrcholy zde vidíme dva \texttt{elType} s názvy \texttt{BasicNode} a \texttt{BasicNodeTwo}.
První nemá žádné vlastnosti, ale druhá má vlastnost \texttt{PropertyOne} s typem \texttt{integer}.
...
Práce s řetězci je obecný problém a existuje mnoho znakových sad, proto bychom chtěli zvolit vstupní řetězce pouze se základní znaky ASCII v rozsahu hodnot 0 až 127.  
...
To znamená, že první v JSON objektu je jako první v daném seznamu.
...
\begin{code}
Soubor hran:
ID elType fromID toID Vlastnosti... // bez této hlavičky
50 BasicEdge 0 0 
51 BasicEdgeTwo 0 1 44
...
Soubor vrcholů:
ID elType Vlastnosti... // bez této hlavičky
0 BasicNode
1 BasicNodeTwo 42
...
\end{code}
