...
Místo ukládaní výsledků do tabulky budeme výsledky použivat rovnou jako klíče paralelní mapy.
Tímto vyřešíme problém synchronizace tabulky.
Také jsme vyřešili požadavek omezení ukládaní pouze na reprezentanty skupin.
Pokud výsledek byl úspěšně vložen do paralelní mapy, tak je považován za uložený.
V opačném případě jej použijeme pouze k aktualizaci hodnot agregačních funkcí a můžeme jej zahodit.
Jak jsme ale dříve zmínili, výsledek hledání je pole proměnných a to náleží struktuře vzoru..
Musíme tedy vytvořit nové pole a výsledek překopírovat.
Nové pole nemusíme vytvářet pokaždé. 
Stačí si pouze pamatovat, jestli použitá kopie byla vložena do paralelní mapy.
Pokud ano, vytvoříme pole nové, jinak pro další výsledek pouze přepíšeme jeho vnítřní hodnoty.
