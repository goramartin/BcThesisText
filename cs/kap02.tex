...
Proměnným pak můžeme přiřadit \verb+ID+ dle pořadí výskytu v Match části.
...
U \verb+avg+ se očekává hodnota s desetinnou částkou.  
...
Systém vytváření a vyhodnocování výrazů za běhu je složitý problém.
...
Zde předpokládáme, že pole Element[ ] obsahuje proměnné přesně v pořadí, jak se vyskytly v části Match.
