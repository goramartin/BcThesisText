...
Dále, opět zde vidíme zpomalení implementace List vůči Bucket.
...
Pro budoucí práci by bylo vhodné udělat podrovnější testování pro rozličtné počty použitých vláken a sledovat scalabilitu daných řešení.
Doposud jsme používali agregační funkce \verb+min+ a \verb+avg+ nyní přejdeme k výsledkům, která pouze seskupují výsledky vyhledávání.
