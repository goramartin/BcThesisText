...
Pro připomenutí zmíníme, že proměnné použité v jiných částech než Match způsobují ukládání daných promenných do tabulky.
Přidělené zkratky dotazům budou uváděný ve výsledcích experimentu místo celých dotazů. 
...
Pro volbu agregačních funkcí jsme zvolili \verb+min(y.PropOne)+ a \verb+avg(y.PropOne)+, protože představují netriviální praci narozdíl od funkcí \verb+sum+/\verb+count+.
