...
\item G\_Q4 a G\_Q5 přidávají režii za ukládání a zpracovávání další proměnné. Počet skupin je ze shora omezen počtem hran v grafu. Tyto dotazy obsahují nejvíce skupin mezi zbylými dotazy.
...
Prvních dvě jsou obsaženy vždy a poslední je použit popuze v paralelní části \textit{Group by}.
...
Pokud je sloupečků více, zarovnání probíhá paralelně.
...
Při porovnávání je nutné mít na paměti, že jednovláknově bežící části používají optimalizace popsané v sekcích \ref{anal.orderby.opt1}, \ref{anal.orderby.opt2} a \ref{impl.orderby.opts}.  
...
Při porovnávání je nutné mít na paměti, že lokálně bežící části používají optimalizace popsané v sekcích \ref{anal.orderby.opt1}, \ref{anal.orderby.opt2} a \ref{impl.orderby.opts}.  
