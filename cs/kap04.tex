...
Existují dvě hlavní metody meření a to pomocí třídy \texttt{Stopwatch} nebo přísup k vlastnosti \texttt{Process.TotalProcessorTime}.
...
Na grafu Amazon0601 u  G\_Q4 a G\_Q5 dotazů je Streamed řešení pomalejší než Half-Streamed (List), protože také vytváří pole jako Bucket řešení (viz implementace \ref{impl.improvement.groupby.streamed}).
