...
Protože benchmark je implementovám v jazyce C\# \citep{microsoft}, rozhodli jsme se využít nativních možností měření uběhlé doby.
V jazyce C\# existují dvě hlavní metody meření a to pomocí třídy \texttt{Stopwatch} nebo přísup k vlasnotsti \texttt{Process.TotalProcessorTime}.
