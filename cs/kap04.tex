...
Je to způsobeno nutným přístupem k databázi, při kterém se ověřuje, jestli daná Property existuje na daném elementu a následném čtení hodnoty ze struktury obsahující ji.
...
Pro představu pouhé režie paralelní mapy jsme otestovali overhead zvlášť čtení a vložení \verb+ConcurrentDictionary+ vůči \verb+Dictionary+ pro jedno vlákno.
...
Pro Normal: Global nastává zpomalení, jelikož se při vkládání do mapy častěji vyvolá drahé porovnání klíčů pomocí Properties skrze tabulku výsledků. 
